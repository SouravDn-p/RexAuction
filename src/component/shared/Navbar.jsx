      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          <Link to="/">
            <div className="flex items-center">
              ...
              />
              <h1 className="font-bold text-xl lg:text-2xl">
                <span className="text-yellow-400 font-serif tracking-wide">Rex</span>
                <span className="text-white"> Auction</span>
              </h1>
            </div>
          </Link>

          <div className="text-lg font-bold hidden md:block text-white">{currentTime}</div>
            ...
            {user?.email ? (
              <>
                ...
                <button
                  onClick={handleGoogleSignOut}
                  className={`${
                    isDarkMode ? "bg-purple-700 hover:bg-purple-600" : "bg-purple-500 hover:bg-purple-700"
              ...
              <Link
                to="/login"
                className={`${
                  isDarkMode ? "bg-purple-700 hover:bg-purple-600" : "bg-purple-500 hover:bg-purple-600"
        ...
        >
          ...
          <div className="flex flex-col items-start space-y-4 p-10 py-6 text-lg font-bold">
            ...
            <Link to="/aboutUs" className={getNavLinkClass("/aboutUs")} onClick={() => setMobileMenuOpen(false)}>
              About Us
            </Link>
