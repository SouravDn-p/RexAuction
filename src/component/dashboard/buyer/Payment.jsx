...
export default function Payment() {
  ...
  return (
    <div className="bg-white min-h-screen p-6 md:p-10 text-[#1d1d1f] font-sans">
      {/* Header */}
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4 flex-wrap">
              ...
              <button className="bg-gray-100 text-gray-600 px-4 py-2 rounded flex gap-1 mb-2 md:mb-0">
                {" "}
                <GrPaypal className="mt-1" />
                <span>PayPal</span>
              </button>
              <button className="bg-gray-100 text-gray-600 px-4 py-2 rounded mb-2 md:mb-0">
                More Options
              </button>
            </div>
            {/* Card Form */}
            <div className="space-y-4">
              <input
                ...
                className=" p-2 rounded-lg  border w-full bg-white"
              />
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-4">
                  <input
                    ...
                    className="p-2 rounded-lg  border w-full bg-white"
                  />
                  <select className="p-2 rounded-lg  border w-full bg-white">
                ...
                <div className="flex gap-4">
                  <input
                    ...
                    className="p-2 rounded-lg  border w-full bg-white"
                  />
                  <select className="p-2 rounded-lg  border bg-white">
            ...
            <div className="mt-6">
              ...
              <button
                className={`${
                  isAgreed ? "bg-purple-600" : "bg-gray-400 cursor-not-allowed"
                } text-white w-full py-3 rounded text-lg font-semibold`}
                disabled={!isAgreed}
              >
                Pay $2,475.00
              </button>
        ...
        <div className="bg-purple-100 p-6 rounded-md">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            ...
            <div className="flex justify-between font-bold text-black border-t-2 border-gray-300 pt-2">
              <span>Total</span>
              <span>$2,475.00</span>
            </div>
          </div>
