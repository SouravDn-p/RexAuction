...
export default function Payment() {
  ...
  const handleDownloadInvoice = () => {
    ...
    doc.text(`$${auctionData?.currentBid?.toLocaleString() || "0.00"}`, 100, 55)
  ...
  if (loading) {
    return (
      <div className={`${bgMain} min-h-screen flex justify-center items-center`}>
  ...
  if (!auctionData) {
    return (
      <div className={`${bgMain} min-h-screen p-6 md:p-10 font-sans flex flex-col items-center justify-center`}>
