...
const NotificationHandler = () => {
  ...
  useEffect(() => {
    if (user && !socketRef.current) {
      ...
      socketRef.current.on("receiveNotification", (notification) => {
        console.log("New notification received in NotificationHandler:", notification)
        ...
        } else if (notification.type === "announcement" && notification.announcementData) {
  ...
  const viewNotificationDetails = (notification) => {
    ...
    } else if (notification.type === "auction-win" && notification.auctionData?._id) {
