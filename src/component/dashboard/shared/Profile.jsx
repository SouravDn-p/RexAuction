        ...
        <div className="grid mt-5 grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className={boxStyle}>
            <div className="p-4 text-center">
              <div className={titleStyle}>
                <CountUp
                  end={profileData.stats.auctionsWon}
                  duration={3.5}
                  enableScrollSpy
                />
              </div>
          ...
          <div className={boxStyle}>
            <div className="p-4 text-center">
              <div className={titleStyle}>
                <CountUp
                  end={profileData.stats.activeBids}
                  duration={3.5}
                  enableScrollSpy
                />
              </div>
          ...
          <div className={boxStyle}>
            <div className="p-4 text-center">
              <div className={titleStyle}>
                <CountUp
                  end={profileData.stats.successRate}
                  duration={3.5}
                  suffix="%"
                  enableScrollSpy
                />
          ...
          <div className={boxStyle}>
            <div className="p-4 text-center">
              <div className={titleStyle}>
                <CountUp
                  end={profileData.stats.totalSpent}
                  duration={1.5}
                  prefix="$"
                  enableScrollSpy
                />
            ...
            >
              ...
              <div className="p-4">
                ...
                >
                  {inView ? (
                    <CountUp
                      end={profileData.accountBalance}
                      duration={1.5}
                      prefix="$"
                    />
                  ) : (
