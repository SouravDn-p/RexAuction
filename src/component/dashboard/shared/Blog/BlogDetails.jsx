...
const BlogDetails = () => {
    ...
    if (isError) return (
        <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? "bg-gray-900" : "bg-white"}`}>
            <div className="text-center p-8 max-w-md mx-auto">
                ...
                <p className="mb-6">We couldn't retrieve the blog details. Please try again later.</p>
                <Link 
                    to="/blogs" 
                    className={`px-6 py-3 rounded-full font-medium inline-flex items-center ${isDarkMode ? "bg-purple-600 hover:bg-purple-700" : "bg-purple-500 hover:bg-purple-600"} text-white`}
                >
    ...
    return (
        <div
            className={`min-h-screen pt-6 pb-14 px-4 md:px-8 transition-colors duration-300 ${isDarkMode
        ...
        >
            ...
            <div className="max-w-6xl mx-auto">
                <Link 
                    to="/blogs" 
                    className={`inline-flex items-center mb-6 px-4 py-2 rounded-full transition-all ${isDarkMode ? "bg-gray-700 hover:bg-gray-600" : "bg-white hover:bg-gray-100"} shadow-sm`}
                >
                    <FaArrowLeft className="mr-2" />
                    Back to Blogs
                </Link>
                ...
                <div className={`p-6 md:p-8 rounded-2xl shadow-lg mb-10 transition-all duration-300 ${isDarkMode ? "bg-gray-800" : "bg-white"}`}>
