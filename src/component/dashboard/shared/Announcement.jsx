...
import { FiEdit, FiTrash, FiBell, FiInfo, FiChevronLeft, FiChevronRight } from "react-icons/fi"
...
const Announcement = () => {
  ...
  const viewNotificationDetails = (notification) => {
    ...
    setAllNotifications((prev) => prev.map((n) => (n._id === notification._id ? { ...n, read: true } : n)))
          ...
          <div key={item._id} className="card-flip-container">
            <div className="card-flip-inner">
              ...
              >
                ...
                <div className="p-4">
                  <p className={`text-sm text-gray-300 mb-1 ${isDarkMode ? "text-gray-300" : "text-gray-800"}`}>
                    {new Date(item.date).toLocaleDateString()}
                  </p>
                  <h2 className="text-lg font-bold text-purple-500 mb-2">{item.title}</h2>
                </div>
              </div>
              ...
              <div className="space-y-5">
                ...
                {notificationDetails.type === "auction" && notificationDetails.auctionData && (
                  <div className={`mt-6 border-t pt-6 ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
                    ...
                    <div
                      className={`rounded-xl overflow-hidden shadow-lg ${isDarkMode ? "bg-gray-700" : "bg-gray-100"}`}
                    >
                      ...
                      <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <p className="mt-1 font-medium">{notificationDetails.auctionData.condition || "N/A"}</p>
                          </div>
                          <div>
                            <h6 className="text-sm font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                              Item Year
                            </h6>
                            <p className="mt-1 font-medium">{notificationDetails.auctionData.itemYear || "N/A"}</p>
                          </div>
                          <div>
                            <h6 className="text-sm font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                              Total Bids
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-4 p-4 rounded-lg bg-white dark:bg-gray-600">
                            <div className="w-12 h-12 rounded-full overflow-hidden">
                              <img
                                src={
                                  notificationDetails.auctionData.sellerPhotoUrl ||
                                  "/placeholder.svg" ||
                                  "/placeholder.svg" ||
                                  "/placeholder.svg" ||
                                  "/placeholder.svg"
                              ...
                              {notificationDetails.auctionData.topBidders.map((bidder, index) => (
                                ...
                                >
                                  ...
                                  <span className="text-gray-500 dark:text-gray-400">
                                    {bidder.timestamp ? new Date(bidder.timestamp).toLocaleTimeString() : "N/A"}
                                  </span>
                                </div>
                              ))}
                            </div>
                ...
                {isAdmin && notificationDetails.type === "announcement" && (
                  <>
                    ...
                    >
                      ...
                      <span>{notificationDetails.announcementData?._id ? "Already Posted" : "Post Announcement"}</span>
                    </button>
                    {notificationDetails.announcementData?._id && (
                      <button
                        onClick={() => {
