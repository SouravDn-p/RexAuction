...
const PasswordSettings = () => {
  ...
  return (
    <div className={`max-w-3xl mx-auto p-4 ${isDarkMode ? ' text-gray-100' : 'bg-white text-gray-800'}`}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={`mb-6 p-4 rounded-md ${
          ...
          <h3 className={`font-medium mb-2 ${isDarkMode ? 'text-gray-200' : ''}`}>
