...
import { FaFire, FaSearch, FaSadTear, FaClock, FaGavel, FaEye } from "react-icons/fa";
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
                    ...
                    <div className="relative w-full md:w-96">
                        <input
                            ...
                            className={`w-full py-3 px-5 pr-10 rounded-full focus:outline-none focus:ring-2 ${isDarkMode
                        ...
                        />
                        <FaSearch
                            className={`absolute right-4 top-1/2 transform -translate-y-1/2 ${isDarkMode ? "text-gray-400" : "text-gray-500"
                                }`}
                        />
                    </div>
                </div>
                ...
                {!filteredAuctions.length && (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-3">
                            {searchTerm ? "No matching auctions found" : "No upcoming auctions available"}
                        </h3>
                        ...
                        <div className="flex overflow-x-auto space-x-6 pb-4 snap-x snap-mandatory">
                            {displayedAuctions.map((item) => (
                                <motion.div
                                    ...
                                    whileHover={{ y: -5 }}
                                    className={`flex-shrink-0 w-72 rounded-xl overflow-hidden transition-all duration-300 snap-start ${isDarkMode
                            ...
                            <div className="flex justify-center mt-12">
                                <nav className="flex items-center space-x-1 sm:space-x-2">
                                    <button
                                        ...
                                        className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center ${isDarkMode
                                    ...
                                    {getPaginationItems().map((page, index) =>
                                        typeof page === "number" ? (
                                            <button
                                                ...
                                                className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center ${currentPage === page
