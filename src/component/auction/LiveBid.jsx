...
import { useAddBidsMutation, useGetTopBiddersQuery, useGetRecentActivityQuery } from "../../redux/features/api/LiveBidApi";
...
export default function LiveBid() {
  ...
  const handlePlaceBid = async () => {
    ...
    if (!bidAmount || parseFloat(bidAmount) <= (liveBid?.currentBid || liveBid?.startingPrice || 0)) {
