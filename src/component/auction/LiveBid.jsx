...
export default function LiveBid() {
  ...
  return (
    ...
    >
      <div
        className={`
  w-11/12 mx-auto mt-20 bg-gray-50 p-6 rounded-xl shadow-lg 
  ${isDarkMode ? "bg-gray-900 text-white border border-gray-700" : "bg-white"}`}
      >
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          ...
          <div className="lg:w-2/3 w-full">
            ...
            <div
              ...
              } grid grid-cols-2 sm:grid-cols-4 gap-5 text-black font-semibold  p-4 rounded-lg shadow-md`}
            >
              <div>
                <h3 className="text-gray-600">Condition:</h3>
                <p className="text-gray-400">Good</p>
              </div>
              <div>
                <h3 className="text-gray-600">Year</h3>
                <p className="text-gray-400">1823</p>
              </div>
              <div>
                <h3 className="text-gray-600">Starting Price:</h3>
                <p className="text-gray-400">$5000.00</p>
              </div>
              <div>
                <h3 className="text-gray-600">Reference</h3>
                <p className="text-gray-400">#HHDDJ77</p>
              </div>
            </div>

            {/* Seller Details */}
            <div className="pt-6">
              <h3 className="text-xl  font-semibold pb-2">Seller</h3>
              <div
                className={`${
                  isDarkMode ? "bg-gray-800 text-white" : "bg-white"
                } flex gap-3 items-center bg-white p-4 rounded-lg shadow-md`}
              >
                <img
                  src={img}
          ...
          <div className="lg:w-1/3 w-full space-y-6">
            ...
            <div
              ...
              } border  p-5 rounded-lg shadow-md`}
            >
              ...
              {/* Custom Bid Input */}
              <div className={` ${isDarkMode ? "" : ""} mt-4 `}>
                <input
                  type="number"
                  placeholder="Enter your bid"
                  className="w-full p-2 border bg-white dark:bg-gray-700 border-gray-300 rounded-lg  focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
              </div>
