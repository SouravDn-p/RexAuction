...
import { FaFire, FaGavel, FaChevronLeft, FaChevronRight, FaSearch, FaSadTear } from "react-icons/fa";
  ...
  if (isLoading) {
    return (
      <div className={isDarkMode ? "bg-gray-900 min-h-screen" : "bg-white min-h-screen"}>
        <Banner isDarkMode={isDarkMode} searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
        <p className={`text-center py-10 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
          Loading auctions...
        </p>
      </div>
    );
      ...
      <section>
        ...
        <div className="w-11/12 mx-auto p-10">
          ...
          {!filteredAuctions.length && (
            <div className={`text-center py-20 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
            ...
            <div className="relative">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-10">
                {displayedAuctions.map((item, index) => (
                  <div
                    key={item._id || index}
                    className={`rounded-lg overflow-hidden transition-transform duration-500 h-full flex flex-col ${
                      isDarkMode
                  ...
                  >
                    ...
                    <div className={`p-4 flex-grow flex flex-col ${
                      isDarkMode ? "text-gray-200 bg-gray-950" : "text-gray-800 bg-gray-50"
                    }`}>
                      ...
                      <div className="flex justify-between items-center mb-3">
                        ...
                        <span className={`text-sm ${
                          countdowns[index] < 3600 ? "text-red-500 font-semibold" : 
              ...
              {pageCount > 1 && (
                <div className="flex justify-center items-center gap-4 mb-6">
                  ...
                  <div className={`px-4 py-2 rounded-full ${
                    ...
                    <span className="font-medium">{currentPage + 1} / {pageCount}</span>
                  </div>
...
// Banner Component
const Banner = ({ isDarkMode, searchTerm, setSearchTerm }) => (
