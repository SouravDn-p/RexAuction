                  ...
                  {displayedAuctions.map((item) => {
                    ...
                    return (
                      ...
                      >
                        {/* Status Badge */}
                        <div
                          className={`absolute top-4 left-4 z-10 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 backdrop-blur-md shadow-lg ${timeStatus === "ending-soon"
                        ...
                        >
                          ...
                          >
                            {favorites.includes(item._id) ? (
                              ...
                              <FaRegHeart
                                className={`text-xl ${isDarkMode ? "text-gray-200" : "text-gray-800"
                                  }`}
                              />
                            )}
                          </motion.div>
                        ...
                        >
                          ...
                          <div className="flex justify-between items-center mb-3">
                            <div className="flex items-center gap-2">
                              <p
                                className={`text-md ${isDarkMode ? "text-gray-400" : "text-gray-500"
                                  }`}
                              >
                                Current Bid:
                              </p>
                            ...
                            <div
                              className={`flex items-center space-x-2 px-3 py-1.5 rounded-full ${isDarkMode ? "bg-gray-800" : "bg-gray-100"
                                }`}
                            >
                              <FaGavel
                                className={
